...
const admin_Route = require("./Routes/Login/adminLogin");
const student_Route = require("./Routes/Login/studentLogin");
const teacher_Route = require("./Routes/Login/teacherLogin");

// Imported Admin Student CRUD
const add_student_Route = require("./Routes/Admin_CRUD_Student/addStudent.js");
